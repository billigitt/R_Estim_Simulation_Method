function [w_Sim, w_EE, Means, EEMeans, Disag, CIs, EECIs, PlotterInputs, totalSimulations] = AnalysisFunctionEdit(MainInput, N_Sim)
...
%THIS FUNCTION IS AN EDIT OF ANALYSISFUNCTION.M. IT IS TO BE USED WITH
%SIMULATIONINFERENCE_PARALLELEDIT.M AND WILL ALSO RECORD NUMBER OF
%SIMULATIONS TO GET MATCHING CRITERIA.
...
if isfield(MainInput, 'NoParallelToolBox')
    ...
    SimulationOutputStruct = SimulationInference_ParallelEdit(SimulationInputStruct);
...
totalSimulations = SimulationOutputStruct.totalSimulations;
