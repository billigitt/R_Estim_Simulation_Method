...
LoadingStruct = load('Wales_2019-20_AnalysisVaryM.mat');
PlotterStructs = LoadingStruct.PlotterStructs;

ActualAnalysis = load('../Cluster/MatFiles/Wales_2019-20_Analysis.mat');
...
h(2) = fill(daysflipCI+1, inBetweenCI, ColourMat(2, :) , 'LineWidth', 0.1, ...
        'edgecolor', [1 1 1]);
set(h(2),'facealpha',.5)
