...
PlotterStructs = cell(6, 1);
totalSimulations = cell(6,1);

matchingpairs = 100;
pvals = 5:5:30;
elapsedTime = zeros(6, 1);
...
for i = 1:6
    ...
    InferenceInput.MatchingPairsPerCore = matchingpairs;

    [w_Sim{1}, w_EE, ~, ~, Disag{1}, ~, ~, PlotterStructs{i}] = AnalysisFunction(InferenceInput, pvals(i));

    elapsedTime(i) = toc;
        
end

save('P5-10-15-20-25-30vsM100Analysis.mat', 'PlotterStructs', 'totalSimulations', 'elapsedTime');
