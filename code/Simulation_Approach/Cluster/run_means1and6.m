function run_means1and6(Seed, Workers)
...
[MeansOutput, I_data_Matrix, I_disag_1, I_disag_2, CIs_1, CIs_2] = MeansLargeScaleComputation_1And6(Seed, Workers);

% take the power of each element


% save output
save(strcat(save_output,'LatestMeansResults_NoCondition_P1and6','_Seed_',string(Seed), '.mat'), ...
